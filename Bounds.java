...
public final class Bounds {
    ...
    public static final boolean isAtDungeoneeringLobby(WorldTile tile) {
	return (tile.getX() >= 3084 && tile.getX() <= 3092
		&& tile.getY() >= 3929 && tile.getY() <= 3937);
    }

    public static final boolean isAtForinthryDungeon(WorldTile tile) {
	return (tile.getX() >= 3011 && tile.getX() <= 3132
		&& tile.getY() >= 10052 && tile.getY() <= 10175);
    }

    public static final boolean isAtWilderness(WorldTile tile) {
	return (tile.getX() >= 3011 && tile.getX() <= 3132
		&& tile.getY() >= 10052 && tile.getY() <= 10175)
    ...
    public static final boolean isAtWildernessDitch(WorldTile tile) {
    ...
    public static final boolean isAtWildernessSafeZone(WorldTile tile) {
	return (tile.getX() >= 2940 && tile.getX() <= 3395
		&& tile.getY() <= 3524 && tile.getY() >= 3523 || tile.getX() >= 3084
		&& tile.getX() <= 3092
		&& tile.getY() >= 3929
