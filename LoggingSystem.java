...
public class LoggingSystem {
	...
	try {
	    String FILE_PATH = DataConstant.LOGS_PATH + "/deathlogs/";
	...
	// TODO Auto-generated method stub
	try {
	    String FILE_PATH = DataConstant.LOGS_PATH + "/stakelogs/";
	    DateFormat dateFormat = new SimpleDateFormat("MM/dd/yy HH:mm:ss");
	    Calendar cal = Calendar.getInstance();
	    BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH
	...
	if (!player.isOwner()) {
	    String FILE_PATH = DataConstant.LOGS_PATH + "/iplogs/";
	...
	// TODO Auto-generated method stub
	String FILE_PATH = DataConstant.LOGS_PATH + "/pmlogs/";
	try {
	    DateFormat dateFormat = new SimpleDateFormat("MM/dd/yy HH:mm:ss");
	    Calendar cal = Calendar.getInstance();
	    BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH
	...
	// TODO Auto-generated method stub
	String FILE_PATH = DataConstant.LOGS_PATH + "/chatlogs/";
	try {
	    DateFormat dateFormat = new SimpleDateFormat("MM/dd/yy HH:mm:ss");
	    Calendar cal = Calendar.getInstance();
	    BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH
	...
	try {
		...
		return;
	    String FILE_PATH = DataConstant.LOGS_PATH + "/tradelogs/";
	    DateFormat dateFormat = new SimpleDateFormat("MM/dd/yy HH:mm:ss");
	    Calendar cal = Calendar.getInstance();
	    BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH
	...
	// TODO Auto-generated method stub
	try {
	    String FILE_PATH = DataConstant.LOGS_PATH + "/moneypouch/";
	    DateFormat dateFormat = new SimpleDateFormat("MM/dd/yy HH:mm:ss");
	    Calendar cal = Calendar.getInstance();
	    BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH
		    + player.getUsername() + ".txt", true));
	    writer.write("[" + dateFormat.format(cal.getTime()) + "] :"
		    ...
		    + ", Inventory: " + player.getInventory().getNumerOf(995)
		    + ".");
	    writer.newLine();
	    writer.flush();
	    writer.close();
